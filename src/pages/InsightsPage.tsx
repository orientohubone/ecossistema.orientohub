  ...
  return (
    <>
      ...
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        className="bg-gradient-to-r from-yellow-400 to-amber-500 rounded-2xl p-6 text-gray-900"
      >
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-900/90 mb-4">
            ...
            <div className="flex items-center gap-3">
              <button className="px-6 py-2.5 bg-gray-900 text-yellow-400 font-bold rounded-xl hover:bg-gray-800 transition-all">
                Implementar Agora
              </button>
              <button className="px-6 py-2.5 bg-black/10 backdrop-blur-sm text-gray-900 font-medium rounded-xl hover:bg-black/20 transition-all border border-gray-900/20">
