  ...
  return (
    <>
      ...
      <main className="min-h-screen overflow-hidden bg-[#0c121b] text-white">
        ...
        <section className="container-custom py-12 sm:py-16"><div className="rounded-3xl border border-primary-400/25 bg-primary-500/10 p-7 text-center sm:p-10"><Sparkles className="mx-auto h-7 w-7 text-primary-300" /><h2 className="mx-auto mt-4 max-w-2xl text-3xl font-bold">Vamos desenhar a melhor próxima etapa para sua empresa?</h2><p className="mx-auto mt-3 max-w-xl text-[#d7e0ea]">Converse com a OrientoHub e entenda qual combinação de estratégia e execução faz sentido agora.</p><Link to="/contato" className="mt-7 inline-flex items-center gap-2 rounded-xl bg-primary-500 px-5 py-3.5 text-sm font-bold text-[#0c121b] transition hover:bg-primary-400">Falar com a OrientoHub <ArrowRight className="h-4 w-4" /></Link></div></section>
      </main>
    </>
  );
};
