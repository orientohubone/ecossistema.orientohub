        ...
        <div className="container-custom relative z-10 py-12 px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
            ...
            />
              ...
              {/* Social Proof */}
              <div className="mt-12 p-6 bg-white/5 border border-primary-500/20 rounded-xl backdrop-blur-sm">
                <div className="flex items-center gap-4 mb-4">
                  <div className="flex -space-x-3">
                    {[1, 2, 3, 4].map((i) => (
                      <div key={i} className="w-10 h-10 rounded-full border-2 border-gray-900 bg-gradient-to-br from-primary-400 to-primary-600" />
                    ))}
                  </div>
                  <div>
                    ...
                    <p className="text-sm text-gray-400">4.9/5 de satisfação</p>
                  </div>
                </div>
                <p className="text-gray-300 italic">
                  "A plataforma que faltava para acelerar minha startup. Recomendo!"
                </p>
                <p className="text-sm text-gray-400 mt-2">- Maria Silva, Founder na TechStart</p>
              </div>
            </motion.div>
